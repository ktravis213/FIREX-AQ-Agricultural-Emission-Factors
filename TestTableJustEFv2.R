# Do ER or do EF
source("~/Library/CloudStorage/OneDrive-NASA/FIREX/Table4.R")
source("~/Library/CloudStorage/OneDrive-NASA/FIREX/speciateSpecies.R")
...
if (doEF == 1){ save_as_docx(`Emission Factors` = ft,  path ='/Users/ktravis1/OneDrive - NASA/FIREX/testEFmean.docx', pr_section = sect_properties)}
if (doER == 1){ save_as_docx(`Emission Ratios` = ft,  path ='/Users/ktravis1/OneDrive - NASA/FIREX/testERmean.docx', pr_section = sect_properties)}
